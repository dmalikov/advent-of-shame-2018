...
-- TODO: can accumulating logic be total, and only execution be partial?
...
solve2 l@(x :: xs) = pure (solve2' 0 empty $ cycle l)
...
day01 = do
  ...
  -- TODO: instead of swallowing bad input, can we raise it via EXCEPTION?
  ints <- (catMaybes . map parseInteger) <$> readFile' "input/day01.txt"
  print (solve1 ints)
  -- TODO: can we avoid this putStr boilerplate in every file?
  putStr " | "
